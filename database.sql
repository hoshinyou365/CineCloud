...
SELECT * FROM (
    SELECT 'Interstellar','Sci-Fi',169,18.00,'images/interstellar.svg'
    UNION ALL SELECT 'The Batman','Action',176,16.00,'images/batman.svg'
    UNION ALL SELECT 'Inside Out 2','Animation',96,14.00,'images/insideout2.svg'
    UNION ALL SELECT 'Top Gun: Maverick','Action',130,17.00,'images/topgun.svg'
) AS seed
